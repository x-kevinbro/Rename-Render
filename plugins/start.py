...
async def start(client, message):
    ...
    button=InlineKeyboardMarkup([[
        InlineKeyboardButton(" Developer ", url='https://t.me/DirectLink_Free')
        ],[
        InlineKeyboardButton(' Updates', url='https://t.me/+4M1goFtfP2Y3ZDM1')
        ],[
        InlineKeyboardButton(' About', callback_data='about'),
        InlineKeyboardButton(' Help', callback_data='help')
        ],[
        InlineKeyboardButton("File To Lnk Bot", url='https://t.me/KeyLink_bot')
        ]
        ])
    if START_PIC:
